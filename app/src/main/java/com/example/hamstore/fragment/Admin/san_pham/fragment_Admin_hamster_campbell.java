...
public class fragment_Admin_hamster_campbell extends Fragment {
    Context c;
    RecyclerView recyclerView;
    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    DatabaseReference data = firebaseDatabase.getReference("Hamster Campbell");
    //thêm
    ...
    StorageReference storageRef = storage.getReference("img_hamster_campbell");
