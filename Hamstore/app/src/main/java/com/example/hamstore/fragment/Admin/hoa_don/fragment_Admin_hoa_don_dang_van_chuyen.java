...
public class fragment_Admin_hoa_don_dang_van_chuyen extends Fragment {
    Context c;
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter adapter = new FirebaseRecyclerAdapter<Hoa_Don, ViewHolder>(options) {
            ...
            protected void onBindViewHolder(ViewHolder holder, int position, Hoa_Don model) {
                ...
                //đã thanh toán
                if(model.getTrang_thai().equals("Đang vận chuyển")) {
                    //hien thi
    ...
    private void dialog_chua_thanh_toan(Hoa_Don hoaDon){
        ...
        //đổi text btn
        btn_xanh.setText("Đã giao hàng");
        btn_do.setText("Hủy bỏ");
        ...
        btn_xanh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                data.child(hoaDon.getId()).child("trang_thai").setValue("Đã giao hàng");
                dialog.dismiss();
            }
        });
        btn_do.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                data.child(hoaDon.getId()).child("trang_thai").setValue("Hủy bỏ");
                dialog.dismiss();
            }
        });
